...
maxmeanmin_plot <- daily_p_fr %>%
  ggplot() +
  geom_line(aes(x = date, y = mean_temp, color = station), linetype = "solid", size = 1) +
  theme_few() +
  geom_line(aes(x = date, y = min_temp, color = station), linetype = "longdash", size = 1) +
  geom_line(aes(x = date, y = max_temp, color = station), linetype = "dotted", size = 1) +
  scale_color_manual(values = c("red", "blue")) +
  transition_reveal(date)


animate(maxmeanmin_plot, nframes=nrow(daily_p))
